...
#define Counter16_INT_MASK                     ( 0x40 )
...
#define Counter16_PERIOD                       ( 0x13 )
#define Counter16_COMPARE_VALUE                ( 0x0 )
...
#pragma ioport  Counter16_COUNTER_LSB_REG:  0x034          //DR0 Counter register LSB
BYTE            Counter16_COUNTER_LSB_REG;
#pragma ioport  Counter16_COUNTER_MSB_REG:  0x038          //DR0 Counter register MSB
BYTE            Counter16_COUNTER_MSB_REG;
#pragma ioport  Counter16_PERIOD_LSB_REG:   0x035          //DR1 Period register LSB
BYTE            Counter16_PERIOD_LSB_REG;
#pragma ioport  Counter16_PERIOD_MSB_REG:   0x039          //DR1 Period register MSB
BYTE            Counter16_PERIOD_MSB_REG;
#pragma ioport  Counter16_COMPARE_LSB_REG:  0x036          //DR2 Compare register LSB
BYTE            Counter16_COMPARE_LSB_REG;
#pragma ioport  Counter16_COMPARE_MSB_REG:  0x03a          //DR2 Compare register MSB
BYTE            Counter16_COMPARE_MSB_REG;
#pragma ioport  Counter16_CONTROL_LSB_REG:  0x037          //Control register LSB
BYTE            Counter16_CONTROL_LSB_REG;
#pragma ioport  Counter16_CONTROL_MSB_REG:  0x03b          //Control register MSB
BYTE            Counter16_CONTROL_MSB_REG;
#pragma ioport  Counter16_FUNC_LSB_REG: 0x134              //Function register LSB
BYTE            Counter16_FUNC_LSB_REG;
#pragma ioport  Counter16_FUNC_MSB_REG: 0x138              //Function register MSB
BYTE            Counter16_FUNC_MSB_REG;
#pragma ioport  Counter16_INPUT_LSB_REG:    0x135          //Input register LSB
BYTE            Counter16_INPUT_LSB_REG;
#pragma ioport  Counter16_INPUT_MSB_REG:    0x139          //Input register MSB
BYTE            Counter16_INPUT_MSB_REG;
#pragma ioport  Counter16_OUTPUT_LSB_REG:   0x136          //Output register LSB
BYTE            Counter16_OUTPUT_LSB_REG;
#pragma ioport  Counter16_OUTPUT_MSB_REG:   0x13a          //Output register MSB
