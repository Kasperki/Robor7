...
export LoadConfig_robottiprojekti
export _LoadConfig_robottiprojekti
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_robottiprojekti
	lcall	LoadConfigTBL_robottiprojekti_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration robottiprojekti
;
;    Load configuration registers for robottiprojekti.
...
;               CUR_PP
;
_LoadConfig_robottiprojekti:
 LoadConfig_robottiprojekti:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_robottiprojekti_Bank0
    mov     X, <LoadConfigTBL_robottiprojekti_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_robottiprojekti_Bank1
    mov     X, <LoadConfigTBL_robottiprojekti_Bank1
