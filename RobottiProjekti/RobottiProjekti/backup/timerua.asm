...
;  Global Symbols
;-----------------------------------------------
export  TimerUA_EnableInt
export _TimerUA_EnableInt
export  TimerUA_DisableInt
export _TimerUA_DisableInt
export  TimerUA_Start
export _TimerUA_Start
export  TimerUA_Stop
export _TimerUA_Stop
export  TimerUA_WritePeriod
export _TimerUA_WritePeriod
export  TimerUA_WriteCompareValue
export _TimerUA_WriteCompareValue
export  TimerUA_bReadCompareValue
export _TimerUA_bReadCompareValue
export  TimerUA_bReadTimer
export _TimerUA_bReadTimer
export  TimerUA_bReadTimerSaveCV
export _TimerUA_bReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  bTimerUA_ReadCompareValue  ; deprecated
export _bTimerUA_ReadCompareValue  ; deprecated
export  bTimerUA_ReadTimer         ; deprecated
export _bTimerUA_ReadTimer         ; deprecated
export  bTimerUA_ReadTimerSaveCV   ; deprecated
export _bTimerUA_ReadTimerSaveCV   ; deprecated

export  bTimerUA_ReadCounter       ; obsolete
export _bTimerUA_ReadCounter       ; obsolete
export  bTimerUA_CaptureCounter    ; obsolete
export _bTimerUA_CaptureCounter    ; obsolete
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TimerUA_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TimerUA_DisableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TimerUA_WritePeriod
;
;  DESCRIPTION:
...
;
 TimerUA_WritePeriod:
_TimerUA_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[TimerUA_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;    functions.
;
 TimerUA_WriteCompareValue:
_TimerUA_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[TimerUA_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TimerUA_bReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 TimerUA_bReadCompareValue:
_TimerUA_bReadCompareValue:
 bTimerUA_ReadCompareValue:                      ; this name deprecated
_bTimerUA_ReadCompareValue:                      ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[TimerUA_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TimerUA_bReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 TimerUA_bReadTimerSaveCV:
_TimerUA_bReadTimerSaveCV:
 bTimerUA_ReadTimerSaveCV:                       ; this name deprecated
_bTimerUA_ReadTimerSaveCV:                       ; this name deprecated
 bTimerUA_ReadCounter:                           ; this name deprecated
_bTimerUA_ReadCounter:                           ; this name deprecated
...
bCount:        equ   1
   ...
   mov   A, reg[TimerUA_CONTROL_REG]             ; save the Control register
   push  A
   mov   A, reg[TimerUA_COMPARE_REG]             ; save the Compare register
   push  A
   mov   A, reg[TimerUA_COUNTER_REG]             ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[TimerUA_COMPARE_REG]             ; Now grab DR2 (DR0) and save
   mov   [X+bCount], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TimerUA_bReadTimer
;
;  DESCRIPTION:
...
;
 TimerUA_bReadTimer:
_TimerUA_bReadTimer:
 bTimerUA_ReadTimer:                             ; this name deprecated
_bTimerUA_ReadTimer:                             ; this name deprecated
 bTimerUA_CaptureCounter:                        ; this name deprecated
_bTimerUA_CaptureCounter:                        ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[TimerUA_COUNTER_REG]             ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[TimerUA_COMPARE_REG]             ; Return DR2 (actually DR0)
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

.ENDSECTION

; End of File TimerUA.asm
