...
export  PWM8_SERVO_bReadPulseWidth
export _PWM8_SERVO_bReadPulseWidth
export  PWM8_SERVO_bReadCounter
export _PWM8_SERVO_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bPWM8_SERVO_ReadPulseWidth    ; deprecated
export _bPWM8_SERVO_ReadPulseWidth    ; deprecated
export  bPWM8_SERVO_ReadCounter       ; deprecated
export _bPWM8_SERVO_ReadCounter       ; deprecated
...
_PWM8_SERVO_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_SERVO_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
_PWM8_SERVO_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_SERVO_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_SERVO_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_SERVO_bReadPulseWidth:
_PWM8_SERVO_bReadPulseWidth:
 bPWM8_SERVO_ReadPulseWidth:                     ; this name deprecated
_bPWM8_SERVO_ReadPulseWidth:                     ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM8_SERVO_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_SERVO_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWM8_SERVO_bReadCounter:
_PWM8_SERVO_bReadCounter:
 bPWM8_SERVO_ReadCounter:                        ; this name deprecated
_bPWM8_SERVO_ReadCounter:                        ; this name deprecated
   ...
   mov   A, reg[PWM8_SERVO_COMPARE_REG]          ; Save the Compare register on the stack
   push  A                                       ;
   PWM8_SERVO_Stop_M                             ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[PWM8_SERVO_INPUT_REG]            ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[PWM8_SERVO_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[PWM8_SERVO_COUNTER_REG]          ; DR2 <- DR0
   mov   A, reg[PWM8_SERVO_COMPARE_REG]          ; Stash the Count on the stack
   ...
   mov   reg[PWM8_SERVO_INPUT_REG], A            ;
   M8C_SetBank0                                  ;
   PWM8_SERVO_Start_M                            ;   then re-enable the PWM.
