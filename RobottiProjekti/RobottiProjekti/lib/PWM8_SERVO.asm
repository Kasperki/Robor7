...
include "m8c.inc"
include "PWM8_SERVO.inc"
include "memory.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  PWM8_SERVO_EnableInt
export _PWM8_SERVO_EnableInt
export  PWM8_SERVO_DisableInt
export _PWM8_SERVO_DisableInt
export  PWM8_SERVO_Start
export _PWM8_SERVO_Start
export  PWM8_SERVO_Stop
export _PWM8_SERVO_Stop
export  PWM8_SERVO_WritePeriod
export _PWM8_SERVO_WritePeriod
export  PWM8_SERVO_WritePulseWidth
export _PWM8_SERVO_WritePulseWidth
export  PWM8_SERVO_wReadPulseWidth
export _PWM8_SERVO_wReadPulseWidth
export  PWM8_SERVO_wReadCounter
export _PWM8_SERVO_wReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  wPWM8_SERVO_ReadPulseWidth    ; deprecated
export _wPWM8_SERVO_ReadPulseWidth    ; deprecated
export  wPWM8_SERVO_ReadCounter       ; deprecated
export _wPWM8_SERVO_ReadCounter       ; deprecated


AREA robottiprojekti_RAM (RAM,REL)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_SERVO_EnableInt
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_SERVO_EnableInt:
_PWM8_SERVO_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWM8_SERVO_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_SERVO_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_SERVO_DisableInt:
_PWM8_SERVO_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWM8_SERVO_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_SERVO_Start
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_SERVO_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_SERVO_WritePeriod:
_PWM8_SERVO_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_SERVO_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[PWM8_SERVO_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_SERVO_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_SERVO_WritePulseWidth:
_PWM8_SERVO_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_SERVO_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[PWM8_SERVO_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_SERVO_wReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_SERVO_wReadPulseWidth:
_PWM8_SERVO_wReadPulseWidth:
 wPWM8_SERVO_ReadPulseWidth:                     ; this name deprecated
_wPWM8_SERVO_ReadPulseWidth:                     ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM8_SERVO_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[PWM8_SERVO_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_SERVO_wReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWM8_SERVO_wReadCounter:
_PWM8_SERVO_wReadCounter:
 wPWM8_SERVO_ReadCounter:                        ; this name deprecated
_wPWM8_SERVO_ReadCounter:                        ; this name deprecated
   ...
   mov   A, reg[PWM8_SERVO_COMPARE_MSB_REG]      ; Save the Compare register on the stack
   push  A                                          ;
   mov   A, reg[PWM8_SERVO_COMPARE_LSB_REG]      ;
   push  A                                          ;  -stack frame now 2 bytes-
   PWM8_SERVO_Stop_M                             ; Disable the PWM function
   M8C_SetBank1                                     ;
   mov   A, reg[PWM8_SERVO_INPUT_LSB_REG]        ; save the LSB clock input setting
   push  A                                          ;   on the stack (now 3 bytes) and ...
                                                    ;   hold the clock low:
   mov   reg[PWM8_SERVO_INPUT_LSB_REG], INPUT_REG_NULL
   M8C_SetBank0                                     ; Extract the Count via DR2 register
   mov   A, reg[PWM8_SERVO_COUNTER_MSB_REG]      ; DR2 <- DR0 (in the MSB block)
   mov   A, reg[PWM8_SERVO_COMPARE_MSB_REG]      ; Stash the Count MSB on the stack
   push  A                                          ;  -stack frame is now 4 bytes
   mov   A, reg[PWM8_SERVO_COUNTER_LSB_REG]      ; DR2 <- DR0 (in the LSB block)
   mov   A, reg[PWM8_SERVO_COMPARE_LSB_REG]      ; Stash the Count LSB on the stack
   ...
   mov   reg[PWM8_SERVO_INPUT_LSB_REG], A        ;    and restore it
   M8C_SetBank0                                     ;
   PWM8_SERVO_Start_M                            ; Now re-enable the PWM function
