...
include "m8c.inc"
include "PWM8_OIKEA.inc"
include "memory.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  PWM8_OIKEA_EnableInt
export _PWM8_OIKEA_EnableInt
export  PWM8_OIKEA_DisableInt
export _PWM8_OIKEA_DisableInt
export  PWM8_OIKEA_Start
export _PWM8_OIKEA_Start
export  PWM8_OIKEA_Stop
export _PWM8_OIKEA_Stop
export  PWM8_OIKEA_WritePeriod
export _PWM8_OIKEA_WritePeriod
export  PWM8_OIKEA_WritePulseWidth
export _PWM8_OIKEA_WritePulseWidth
export  PWM8_OIKEA_bReadPulseWidth
export _PWM8_OIKEA_bReadPulseWidth
export  PWM8_OIKEA_bReadCounter
export _PWM8_OIKEA_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bPWM8_OIKEA_ReadPulseWidth    ; deprecated
export _bPWM8_OIKEA_ReadPulseWidth    ; deprecated
export  bPWM8_OIKEA_ReadCounter       ; deprecated
export _bPWM8_OIKEA_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_OIKEA_EnableInt
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_OIKEA_EnableInt:
_PWM8_OIKEA_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWM8_OIKEA_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_OIKEA_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_OIKEA_DisableInt:
_PWM8_OIKEA_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWM8_OIKEA_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_OIKEA_Start
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_OIKEA_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_OIKEA_WritePeriod:
_PWM8_OIKEA_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_OIKEA_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_OIKEA_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_OIKEA_WritePulseWidth:
_PWM8_OIKEA_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_OIKEA_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_OIKEA_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_OIKEA_bReadPulseWidth:
_PWM8_OIKEA_bReadPulseWidth:
 bPWM8_OIKEA_ReadPulseWidth:                     ; this name deprecated
_bPWM8_OIKEA_ReadPulseWidth:                     ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM8_OIKEA_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_OIKEA_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWM8_OIKEA_bReadCounter:
_PWM8_OIKEA_bReadCounter:
 bPWM8_OIKEA_ReadCounter:                        ; this name deprecated
_bPWM8_OIKEA_ReadCounter:                        ; this name deprecated
   ...
   mov   A, reg[PWM8_OIKEA_COMPARE_REG]          ; Save the Compare register on the stack
   push  A                                       ;
   PWM8_OIKEA_Stop_M                             ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[PWM8_OIKEA_INPUT_REG]            ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[PWM8_OIKEA_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[PWM8_OIKEA_COUNTER_REG]          ; DR2 <- DR0
   mov   A, reg[PWM8_OIKEA_COMPARE_REG]          ; Stash the Count on the stack
   ...
   mov   reg[PWM8_OIKEA_INPUT_REG], A            ;
   M8C_SetBank0                                  ;
   PWM8_OIKEA_Start_M                            ;   then re-enable the PWM.
