...
#define PORT_0_GLOBAL_SELECT   0x13    //Port 0 global select register (PRT0GS)
#define PORT_0_DRIVE_0         0xd3    //Port 0 drive mode 0 register (PRT0DM0)
#define PORT_0_DRIVE_1         0xac    //Port 0 drive mode 1 register (PRT0DM1)
#define PORT_0_DRIVE_2         0x2c    //Port 0 drive mode 1 register (PRT0DM2)
#define PORT_0_INTENABLE       0x88    //Port 0 interrupt enable register (PRT0IE)
#define PORT_0_INTCTRL_0       0x8     //Port 0 interrupt control 0 register (PRT0IC0)
#define PORT_0_INTCTRL_1       0x80    //Port 0 interrupt control 1 register (PRT0IC1)
#define PORT_1_GLOBAL_SELECT   0x0     //Port 1 global select register (PRT1GS)
#define PORT_1_DRIVE_0         0x8f    //Port 1 drive mode 0 register (PRT1DM0)
#define PORT_1_DRIVE_1         0x70    //Port 1 drive mode 1 register (PRT1DM1)
#define PORT_1_DRIVE_2         0x70    //Port 1 drive mode 2 register (PRT1DM2)
